<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.transporttaskstatus.TransportTaskStatus'%>
...
<c:set var="ownerBeanName" value="transportTaskStatus" scope="request"/>
<c:set var="ownerClassName" value="TransportTaskStatus" scope="request"/>
...
<div class="row">
	...
	<% TransportTaskStatus result = (TransportTaskStatus)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transportTaskStatus" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/lsc/transporttaskstatus/TransportTaskStatus$Summary.jsp" />
...
<sky:include page="com/doublechaintech/lsc/platform/Platform$Info.jsp" />
		...
		<div id="transportTaskList" class="tab-pane fade sublist" refer-name="status">
