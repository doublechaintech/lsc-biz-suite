<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.genericform.GenericForm'%>
...
<sky:include page="com/doublechaintech/lsc/genericform/GenericForm$Summary.jsp" />
		...
		<div id="formMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/lsc/formmessage/FormMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldMessageList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/lsc/formfieldmessage/FormFieldMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/lsc/formfield/FormField$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formActionList"] or ignoreListAccessControl}'>
		...
		<div id="formActionList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/lsc/formaction/FormAction$List.jsp"
					referName="form"/>
		</div>
	</c:if>
