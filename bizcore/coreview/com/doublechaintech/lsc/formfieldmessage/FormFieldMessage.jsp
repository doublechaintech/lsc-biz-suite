<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.formfieldmessage.FormFieldMessage'%>
...
<sky:include page="com/doublechaintech/lsc/formfieldmessage/FormFieldMessage$Summary.jsp" />
...
<sky:include page="com/doublechaintech/lsc/genericform/GenericForm$Info.jsp" />
