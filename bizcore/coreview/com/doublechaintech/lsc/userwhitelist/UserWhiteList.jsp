<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/lsc/userwhitelist/UserWhiteList$Summary.jsp" />
