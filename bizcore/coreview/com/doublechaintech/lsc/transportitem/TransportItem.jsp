<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.transportitem.TransportItem'%>
...
<c:set var="ownerBeanName" value="transportItem" scope="request"/>
<c:set var="ownerClassName" value="TransportItem" scope="request"/>
...
<div class="row">
	...
	<% TransportItem result = (TransportItem)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transportItem" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/lsc/transportitem/TransportItem$Summary.jsp" />
...
<c:set var="merchantType" value="${ result.merchant}" scope="request" />
