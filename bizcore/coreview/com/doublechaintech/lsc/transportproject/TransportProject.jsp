<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.transportproject.TransportProject'%>
...
<c:set var="ownerBeanName" value="transportProject" scope="request"/>
<c:set var="ownerClassName" value="TransportProject" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transportProject" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/lsc/transportproject/TransportProject$Summary.jsp" />
