<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/lsc/secuserblocking/SecUserBlocking$Summary.jsp" />
