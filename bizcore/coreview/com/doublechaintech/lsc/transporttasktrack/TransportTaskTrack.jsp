<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.transporttasktrack.TransportTaskTrack'%>
...
<sky:include page="com/doublechaintech/lsc/transporttasktrack/TransportTaskTrack$Summary.jsp" />
	...
	<div class="row">
<c:set var="transportTask" value="${ result.task}" scope="request" />
<sky:include page="com/doublechaintech/lsc/transporttask/TransportTask$Info.jsp" />
