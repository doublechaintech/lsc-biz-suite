<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.transactiontype.TransactionType'%>
...
<c:set var="ownerBeanName" value="transactionType" scope="request"/>
<c:set var="ownerClassName" value="TransactionType" scope="request"/>
...
<div class="row">
	...
	<% TransactionType result = (TransactionType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="transactionType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/lsc/transactiontype/TransactionType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/lsc/platform/Platform$Info.jsp" />
		...
		<div id="transactionList" class="tab-pane fade sublist" refer-name="transaction_type">
			<sky:include page="com/doublechaintech/lsc/transaction/Transaction$List.jsp"
					referName="transactionType"/>
		</div>
	</c:if>
