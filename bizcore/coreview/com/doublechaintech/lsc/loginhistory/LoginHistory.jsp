<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/lsc/loginhistory/LoginHistory$Summary.jsp" />
