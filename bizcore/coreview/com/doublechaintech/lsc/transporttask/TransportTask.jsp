<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.transporttask.TransportTask'%>
...
<sky:include page="com/doublechaintech/lsc/transporttask/TransportTask$Summary.jsp" />
...
<c:set var="location" value="${ result.destination}" scope="request" />
<sky:include page="com/doublechaintech/lsc/location/Location$Info.jsp" />

<c:set var="transportTaskStatus" value="${ result.status}" scope="request" />
<sky:include page="com/doublechaintech/lsc/transporttaskstatus/TransportTaskStatus$Info.jsp" />

<c:set var="merchant" value="${ result.sender}" scope="request" />
<sky:include page="com/doublechaintech/lsc/merchant/Merchant$Info.jsp" />

<c:set var="merchant" value="${ result.receiver}" scope="request" />
<sky:include page="com/doublechaintech/lsc/merchant/Merchant$Info.jsp" />
...
<sky:include page="com/doublechaintech/lsc/platform/Platform$Info.jsp" />
		...
		<div id="transportTaskTrackList" class="tab-pane fade sublist" refer-name="task">
			<sky:include page="com/doublechaintech/lsc/transporttasktrack/TransportTaskTrack$List.jsp"
					referName="task"/>
		</div>
	</c:if>
