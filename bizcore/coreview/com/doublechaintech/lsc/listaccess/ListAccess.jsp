<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/lsc/listaccess/ListAccess$Summary.jsp" />
