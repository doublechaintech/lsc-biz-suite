<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.objectaccess.ObjectAccess'%>
...
<sky:include page="com/doublechaintech/lsc/objectaccess/ObjectAccess$Summary.jsp" />
...
<sky:include page="com/doublechaintech/lsc/userapp/UserApp$Info.jsp" />
