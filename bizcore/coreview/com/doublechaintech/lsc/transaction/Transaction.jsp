<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.transaction.Transaction'%>
...
<sky:include page="com/doublechaintech/lsc/transaction/Transaction$Summary.jsp" />
	...
	<div class="row">
<c:set var="transactionType" value="${ result.transactionType}" scope="request" />
<sky:include page="com/doublechaintech/lsc/transactiontype/TransactionType$Info.jsp" />

<c:set var="merchantAccount" value="${ result.account}" scope="request" />
<sky:include page="com/doublechaintech/lsc/merchantaccount/MerchantAccount$Info.jsp" />
