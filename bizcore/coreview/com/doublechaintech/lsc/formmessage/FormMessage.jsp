<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/lsc/formmessage/FormMessage$Summary.jsp" />
