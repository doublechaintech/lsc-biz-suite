<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.userdomain.UserDomain'%>
...
<sky:include page="com/doublechaintech/lsc/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="userWhiteListList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechaintech/lsc/userwhitelist/UserWhiteList$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["secUserList"] or ignoreListAccessControl}'>
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<sky:include page="com/doublechaintech/lsc/secuser/SecUser$List.jsp"
					referName="domain"/>
		</div>
	</c:if>
