<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.merchanttype.MerchantType'%>
...
<c:set var="ownerBeanName" value="merchantType" scope="request"/>
<c:set var="ownerClassName" value="MerchantType" scope="request"/>
...
<div class="row">
	...
	<% MerchantType result = (MerchantType)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="merchantType" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/lsc/merchanttype/MerchantType$Summary.jsp" />
...
<sky:include page="com/doublechaintech/lsc/platform/Platform$Info.jsp" />
		...
		<div id="merchantList" class="tab-pane fade sublist" refer-name="type">
	...
	<c:if test='${not empty userContext.accessTokens["transportItemList"] or ignoreListAccessControl}'>
		...
		<div id="transportItemList" class="tab-pane fade sublist" refer-name="merchant">
