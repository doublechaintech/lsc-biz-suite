<%@ page import='java.util.*,com.doublechaintech.lsc.*,com.doublechaintech.lsc.merchantaccount.MerchantAccount'%>
...
<c:set var="ownerBeanName" value="merchantAccount" scope="request"/>
<c:set var="ownerClassName" value="MerchantAccount" scope="request"/>
...
<div class="row">
	...
	<% MerchantAccount result = (MerchantAccount)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="merchantAccount" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/lsc/merchantaccount/MerchantAccount$Summary.jsp" />
	...
	<div class="row">
<c:set var="merchant" value="${ result.merchant}" scope="request" />
<sky:include page="com/doublechaintech/lsc/merchant/Merchant$Info.jsp" />
		...
		<div id="transactionList" class="tab-pane fade sublist" refer-name="account">
			<sky:include page="com/doublechaintech/lsc/transaction/Transaction$List.jsp"
					referName="account"/>
		</div>
	</c:if>
