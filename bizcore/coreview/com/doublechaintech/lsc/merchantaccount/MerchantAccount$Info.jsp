...
<div class="col-xs-12 col-ms-6 col-md-4 section">
	...
	<b title="A MerchantAccount">${userContext.localeMap['merchant_account']} </b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./merchantAccountManager/view/${merchantAccount.id}/"> ${merchantAccount.id}</a></li>
