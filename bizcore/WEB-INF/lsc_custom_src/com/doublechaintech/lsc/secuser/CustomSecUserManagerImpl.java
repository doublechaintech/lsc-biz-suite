...
import com.doublechaintech.lsc.LscUserContextImpl;
import com.doublechaintech.lsc.LoginForm;
import com.doublechaintech.lsc.BaseEntity;
import com.doublechaintech.lsc.CommonError;
import com.doublechaintech.lsc.DAOGroup;
import com.doublechaintech.lsc.ManagerGroup;

import com.doublechaintech.lsc.UserContextImpl;
import com.doublechaintech.lsc.userapp.UserApp;
import com.doublechaintech.lsc.LscUserContext;
import com.doublechaintech.lsc.userapp.*;
import com.doublechaintech.lsc.listaccess.*;
import com.doublechaintech.lsc.objectaccess.*;
import com.doublechaintech.lsc.LscChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(LscUserContext userContext){
    ...
    public Object resetPassword(LscUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(LscUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(LscUserContext userContext,
    ...
    public SecUser manage(LscUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(LscUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(LscUserContext userContext) {
    ...
    protected Object gotoApp(LscUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(LscUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(LscUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(LscUserContext userContex, int length){
    ...
    protected String getBeanName(LscUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(LscUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(LscUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(LscUserContext userContext, UserApp app){
    ...
    public Object home(LscUserContext userContext) {
    ...
    public Object loginWithEmail(LscUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(LscUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(LscUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(LscUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(LscUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(LscUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(LscUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(LscUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(LscUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        LscUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected LscChecker checker;
    public LscChecker getChecker(){
        return checker;
    }
    
    public void setChecker(LscChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((LscChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected LscUserContextImpl createNewConext(String path) {

        return new LscUserContextImpl();
    ...
    public Object checkOtherLogin(LscUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(LscUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(LscUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(LscUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(LscUserContext userContext, String secUserId, String objectType,
	...
	public String testIfHasManagementAccess(LscUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
