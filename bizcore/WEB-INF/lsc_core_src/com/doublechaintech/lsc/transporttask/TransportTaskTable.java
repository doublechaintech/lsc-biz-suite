...
public class TransportTaskTable{
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_NAME, COLUMN_SOURCE, COLUMN_DESTINATION, COLUMN_REMARK, COLUMN_STATUS, COLUMN_SENDER, COLUMN_RECEIVER, COLUMN_PLATFORM, COLUMN_CREATE_TIME, COLUMN_UPDATE_TIME, 
		COLUMN_VERSION};
