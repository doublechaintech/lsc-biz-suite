...
public class FormMessageManagerImpl extends CustomLscCheckerManager implements FormMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormMessageManagerException{
 	...
 	protected FormMessage saveFormMessage(LscUserContext userContext, FormMessage formMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormMessage saveFormMessageDetail(LscUserContext userContext, FormMessage formMessage) throws Exception{	
 	...
 	public FormMessage loadFormMessage(LscUserContext userContext, String formMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormMessage searchFormMessage(LscUserContext userContext, String formMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormMessage present(LscUserContext userContext, FormMessage formMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormMessage loadFormMessageDetail(LscUserContext userContext, String formMessageId) throws Exception{	
 	...
 	public Object view(LscUserContext userContext, String formMessageId) throws Exception{	
 		FormMessage formMessage = loadFormMessage( userContext, formMessageId, viewTokens());
 		return present(userContext,formMessage, allTokens());
		
 	}
 	protected FormMessage saveFormMessage(LscUserContext userContext, FormMessage formMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormMessageDAO().save(formMessage, tokens);
 	}
 	protected FormMessage loadFormMessage(LscUserContext userContext, String formMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormMessage(formMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(LscUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(LscUserContext userContext, FormMessage formMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormMessage(LscUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormMessage clone(LscUserContext userContext, String fromFormMessageId) throws Exception{
	...
	public FormMessage internalSaveFormMessage(LscUserContext userContext, FormMessage formMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormMessage updateFormMessageProperty(LscUserContext userContext,String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormMessage(userContext, formMessageId, formMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(LscUserContext userContext, String formMessageId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(LscUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
	...
	public FormMessage forgetByAll(LscUserContext userContext, String formMessageId, int formMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formMessageId, formMessageVersion);		
	}
	protected FormMessage forgetByAllInternal(LscUserContext userContext,
			String formMessageId, int formMessageVersion) throws Exception{
