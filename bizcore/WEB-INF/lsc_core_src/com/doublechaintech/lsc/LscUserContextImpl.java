...
import com.doublechaintech.lsc.secuser.SecUserCustomManagerImpl;
...
public class LscUserContextImpl extends UserContextImpl implements LscUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.lsc.LscResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.lsc.LscCustomResources";
    ...
    /*
    public static SecUser getSecUser(LscUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(LscUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(LscUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(LscUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
