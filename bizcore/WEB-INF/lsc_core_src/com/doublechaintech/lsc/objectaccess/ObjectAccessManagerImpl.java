...
import com.doublechaintech.lsc.userapp.CandidateUserApp;
...
public class ObjectAccessManagerImpl extends CustomLscCheckerManager implements ObjectAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ObjectAccessManagerException{
 	...
 	protected ObjectAccess saveObjectAccess(LscUserContext userContext, ObjectAccess objectAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ObjectAccess saveObjectAccessDetail(LscUserContext userContext, ObjectAccess objectAccess) throws Exception{	
 	...
 	public ObjectAccess loadObjectAccess(LscUserContext userContext, String objectAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ObjectAccess searchObjectAccess(LscUserContext userContext, String objectAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ObjectAccess present(LscUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ObjectAccess loadObjectAccessDetail(LscUserContext userContext, String objectAccessId) throws Exception{	
 	...
 	public Object view(LscUserContext userContext, String objectAccessId) throws Exception{	
 		ObjectAccess objectAccess = loadObjectAccess( userContext, objectAccessId, viewTokens());
 		return present(userContext,objectAccess, allTokens());
		
 	}
 	protected ObjectAccess saveObjectAccess(LscUserContext userContext, ObjectAccess objectAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getObjectAccessDAO().save(objectAccess, tokens);
 	}
 	protected ObjectAccess loadObjectAccess(LscUserContext userContext, String objectAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfObjectAccess(objectAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ObjectAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(LscUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(LscUserContext userContext, ObjectAccess objectAccess, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingObjectAccess(LscUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ObjectAccess clone(LscUserContext userContext, String fromObjectAccessId) throws Exception{
	...
	public ObjectAccess internalSaveObjectAccess(LscUserContext userContext, ObjectAccess objectAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ObjectAccess updateObjectAccessProperty(LscUserContext userContext,String objectAccessId, int objectAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingObjectAccess(userContext, objectAccessId, objectAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(LscUserContext userContext, String objectAccessId, String anotherAppId) throws Exception
 	{
	...
	public CandidateUserApp requestCandidateApp(LscUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected UserApp loadUserApp(LscUserContext userContext, String newAppId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(LscUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
	...
	public ObjectAccess forgetByAll(LscUserContext userContext, String objectAccessId, int objectAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, objectAccessId, objectAccessVersion);		
	}
	protected ObjectAccess forgetByAllInternal(LscUserContext userContext,
			String objectAccessId, int objectAccessVersion) throws Exception{
