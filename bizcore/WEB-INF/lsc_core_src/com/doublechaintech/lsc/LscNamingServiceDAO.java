...
public class LscNamingServiceDAO extends CommonJDBCTemplateDAO {
	...
	static {
		...
		namingTableMap.put("TransactionType", new String[]{"transaction_type_data","name"});
		namingTableMap.put("MerchantType", new String[]{"merchant_type_data","name"});
		namingTableMap.put("TransportTaskStatus", new String[]{"transport_task_status_data","name"});
		namingTableMap.put("Location", new String[]{"location_data","name"});
		namingTableMap.put("Merchant", new String[]{"merchant_data","name"});
		namingTableMap.put("TransportProject", new String[]{"transport_project_data","name"});
		namingTableMap.put("TransportItem", new String[]{"transport_item_data","name"});
		namingTableMap.put("TransportTask", new String[]{"transport_task_data","name"});
		namingTableMap.put("TransportTaskTrack", new String[]{"transport_task_track_data","name"});
		namingTableMap.put("MerchantAccount", new String[]{"merchant_account_data","name"});
