...
public class TransportProjectTable{
	...
	static final String TABLE_NAME="transport_project_data";
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_NAME, COLUMN_MERCHANT, COLUMN_PLATFORM, COLUMN_CREATE_TIME, COLUMN_UPDATE_TIME, 
		COLUMN_VERSION};
