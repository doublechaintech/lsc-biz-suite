...
public class SecUserJDBCTemplateDAO extends LscNamingServiceDAO implements SecUserDAO{
	...
	*/
    ...
    public SmartList<SecUser> requestCandidateSecUserForUserApp(LscUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<SecUser> requestCandidateSecUserForLoginHistory(LscUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(SecUserTable.COLUMN_LOGIN, filterKey, pageNo, pageSize, getSecUserMapper());
    }
