...
public class FormFieldManagerImpl extends CustomLscCheckerManager implements FormFieldManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldManagerException{
 	...
 	protected FormField saveFormField(LscUserContext userContext, FormField formField, String [] tokensExpr) throws Exception{	
 	...
 	protected FormField saveFormFieldDetail(LscUserContext userContext, FormField formField) throws Exception{	
 	...
 	public FormField loadFormField(LscUserContext userContext, String formFieldId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormField searchFormField(LscUserContext userContext, String formFieldId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormField present(LscUserContext userContext, FormField formField, Map<String, Object> tokens) throws Exception {
 	...
 	public FormField loadFormFieldDetail(LscUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, allTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	
 	public Object view(LscUserContext userContext, String formFieldId) throws Exception{	
 		FormField formField = loadFormField( userContext, formFieldId, viewTokens());
 		return present(userContext,formField, allTokens());
		
 	}
 	protected FormField saveFormField(LscUserContext userContext, FormField formField, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldDAO().save(formField, tokens);
 	}
 	protected FormField loadFormField(LscUserContext userContext, String formFieldId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormField(formFieldId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(LscUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(LscUserContext userContext, FormField formField, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormField(LscUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormField clone(LscUserContext userContext, String fromFormFieldId) throws Exception{
	...
	public FormField internalSaveFormField(LscUserContext userContext, FormField formField, Map<String,Object> options) throws Exception 
	{
	...
	public FormField updateFormFieldProperty(LscUserContext userContext,String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormField(userContext, formFieldId, formFieldVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(LscUserContext userContext, String formFieldId, String anotherFormId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(LscUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
	...
	public FormField forgetByAll(LscUserContext userContext, String formFieldId, int formFieldVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldId, formFieldVersion);		
	}
	protected FormField forgetByAllInternal(LscUserContext userContext,
			String formFieldId, int formFieldVersion) throws Exception{
