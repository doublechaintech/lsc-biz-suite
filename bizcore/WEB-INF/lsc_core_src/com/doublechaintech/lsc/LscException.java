...
@JsonSerialize(using = LscExceptionJsonSerializer.class)
public class LscException extends Exception implements MessageContainer {
    ...
    public LscException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public LscException(List<Message> messageList) {
        super();
    ...
    public LscException(String message, Throwable cause) {
        super(message, cause);
    }


    public LscException(Throwable cause) {
        super(cause);
    }
