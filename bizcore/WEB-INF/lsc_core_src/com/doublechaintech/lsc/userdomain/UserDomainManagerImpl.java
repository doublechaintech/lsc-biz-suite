...
public class UserDomainManagerImpl extends CustomLscCheckerManager implements UserDomainManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserDomainManagerException{
 	...
 	protected UserDomain saveUserDomain(LscUserContext userContext, UserDomain userDomain, String [] tokensExpr) throws Exception{	
 	...
 	protected UserDomain saveUserDomainDetail(LscUserContext userContext, UserDomain userDomain) throws Exception{	
 	...
 	public UserDomain loadUserDomain(LscUserContext userContext, String userDomainId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserDomain searchUserDomain(LscUserContext userContext, String userDomainId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserDomain present(LscUserContext userContext, UserDomain userDomain, Map<String, Object> tokens) throws Exception {
 	...
 	public UserDomain loadUserDomainDetail(LscUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, allTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	
 	public Object view(LscUserContext userContext, String userDomainId) throws Exception{	
 		UserDomain userDomain = loadUserDomain( userContext, userDomainId, viewTokens());
 		return present(userContext,userDomain, allTokens());
		
 	}
 	protected UserDomain saveUserDomain(LscUserContext userContext, UserDomain userDomain, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserDomainDAO().save(userDomain, tokens);
 	}
 	protected UserDomain loadUserDomain(LscUserContext userContext, String userDomainId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserDomain(userDomainId);
		userContext.getChecker().throwExceptionIfHasErrors( UserDomainManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(LscUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(LscUserContext userContext, UserDomain userDomain, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserDomain(LscUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserDomain clone(LscUserContext userContext, String fromUserDomainId) throws Exception{
	...
	public UserDomain internalSaveUserDomain(LscUserContext userContext, UserDomain userDomain, Map<String,Object> options) throws Exception 
	{
	...
	public UserDomain updateUserDomainProperty(LscUserContext userContext,String userDomainId, int userDomainVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserDomain(userContext, userDomainId, userDomainVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(LscUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
	...
	public UserDomain forgetByAll(LscUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
		return forgetByAllInternal(userContext, userDomainId, userDomainVersion);		
	}
	protected UserDomain forgetByAllInternal(LscUserContext userContext,
			String userDomainId, int userDomainVersion) throws Exception{
	...
	protected void checkParamsForAddingUserWhiteList(LscUserContext userContext, String userDomainId, String userIdentity, String userSpecialFunctions,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteListProperties(LscUserContext userContext, String userDomainId,String id,String userIdentity,String userSpecialFunctions,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateUserWhiteListProperties(LscUserContext userContext, String userDomainId, String id,String userIdentity,String userSpecialFunctions, String [] tokensExpr) throws Exception
	{	
	...
	protected UserWhiteList createUserWhiteList(LscUserContext userContext, String userIdentity, String userSpecialFunctions) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteListList(LscUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteListList(LscUserContext userContext, String userDomainId, 
			String userWhiteListIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUserWhiteList(LscUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeUserWhiteList(LscUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUserWhiteList(LscUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copyUserWhiteListFrom(LscUserContext userContext, String userDomainId, 
		String userWhiteListId, int userWhiteListVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUserWhiteList(LscUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateUserWhiteList(LscUserContext userContext, String userDomainId, String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingSecUser(LscUserContext userContext, String userDomainId, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUserProperties(LscUserContext userContext, String userDomainId,String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime,String [] tokensExpr) throws Exception {
	...
	public  UserDomain updateSecUserProperties(LscUserContext userContext, String userDomainId, String id,String login,String mobile,String email,String pwd,int verificationCode,DateTime verificationCodeExpire,DateTime lastLoginTime, String [] tokensExpr) throws Exception
	{	
	...
	protected SecUser createSecUser(LscUserContext userContext, String login, String mobile, String email, String pwd, int verificationCode, DateTime verificationCodeExpire, DateTime lastLoginTime) throws Exception{
	...
	protected void checkParamsForRemovingSecUserList(LscUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUserList(LscUserContext userContext, String userDomainId, 
			String secUserIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSecUser(LscUserContext userContext, String userDomainId, 
	...
	public  UserDomain removeSecUser(LscUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSecUser(LscUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	public  UserDomain copySecUserFrom(LscUserContext userContext, String userDomainId, 
		String secUserId, int secUserVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSecUser(LscUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  UserDomain updateSecUser(LscUserContext userContext, String userDomainId, String secUserId, int secUserVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
