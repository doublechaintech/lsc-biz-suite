...
public class GenericFormManagerImpl extends CustomLscCheckerManager implements GenericFormManager {
	...
	protected void throwExceptionWithMessage(String value) throws GenericFormManagerException{
 	...
 	protected GenericForm saveGenericForm(LscUserContext userContext, GenericForm genericForm, String [] tokensExpr) throws Exception{	
 	...
 	protected GenericForm saveGenericFormDetail(LscUserContext userContext, GenericForm genericForm) throws Exception{	
 	...
 	public GenericForm loadGenericForm(LscUserContext userContext, String genericFormId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public GenericForm searchGenericForm(LscUserContext userContext, String genericFormId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected GenericForm present(LscUserContext userContext, GenericForm genericForm, Map<String, Object> tokens) throws Exception {
 	...
 	public GenericForm loadGenericFormDetail(LscUserContext userContext, String genericFormId) throws Exception{	
 	...
 	public Object view(LscUserContext userContext, String genericFormId) throws Exception{	
 		GenericForm genericForm = loadGenericForm( userContext, genericFormId, viewTokens());
 		return present(userContext,genericForm, allTokens());
		
 	}
 	protected GenericForm saveGenericForm(LscUserContext userContext, GenericForm genericForm, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getGenericFormDAO().save(genericForm, tokens);
 	}
 	protected GenericForm loadGenericForm(LscUserContext userContext, String genericFormId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfGenericForm(genericFormId);
		userContext.getChecker().throwExceptionIfHasErrors( GenericFormManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(LscUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(LscUserContext userContext, GenericForm genericForm, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingGenericForm(LscUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public GenericForm clone(LscUserContext userContext, String fromGenericFormId) throws Exception{
	...
	public GenericForm internalSaveGenericForm(LscUserContext userContext, GenericForm genericForm, Map<String,Object> options) throws Exception 
	{
	...
	public GenericForm updateGenericFormProperty(LscUserContext userContext,String genericFormId, int genericFormVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingGenericForm(userContext, genericFormId, genericFormVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public void delete(LscUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
	...
	public GenericForm forgetByAll(LscUserContext userContext, String genericFormId, int genericFormVersion) throws Exception {
		return forgetByAllInternal(userContext, genericFormId, genericFormVersion);		
	}
	protected GenericForm forgetByAllInternal(LscUserContext userContext,
			String genericFormId, int genericFormVersion) throws Exception{
	...
	protected void checkParamsForAddingFormMessage(LscUserContext userContext, String genericFormId, String title, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessageProperties(LscUserContext userContext, String genericFormId,String id,String title,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormMessageProperties(LscUserContext userContext, String genericFormId, String id,String title,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormMessage createFormMessage(LscUserContext userContext, String title, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormMessageList(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessageList(LscUserContext userContext, String genericFormId, 
			String formMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormMessage(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormMessage(LscUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormMessage(LscUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormMessageFrom(LscUserContext userContext, String genericFormId, 
		String formMessageId, int formMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormMessage(LscUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormMessage(LscUserContext userContext, String genericFormId, String formMessageId, int formMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormFieldMessage(LscUserContext userContext, String genericFormId, String title, String parameterName, String level,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessageProperties(LscUserContext userContext, String genericFormId,String id,String title,String parameterName,String level,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormFieldMessageProperties(LscUserContext userContext, String genericFormId, String id,String title,String parameterName,String level, String [] tokensExpr) throws Exception
	{	
	...
	protected FormFieldMessage createFormFieldMessage(LscUserContext userContext, String title, String parameterName, String level) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessageList(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessageList(LscUserContext userContext, String genericFormId, 
			String formFieldMessageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldMessage(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldMessage(LscUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormFieldMessage(LscUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldMessageFrom(LscUserContext userContext, String genericFormId, 
		String formFieldMessageId, int formFieldMessageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormFieldMessage(LscUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormFieldMessage(LscUserContext userContext, String genericFormId, String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	public  GenericForm updateFormFieldProperties(LscUserContext userContext, String genericFormId, String id,String label,String localeKey,String parameterName,String type,String placeholder,String defaultValue,String description,String fieldGroup,String minimumValue,String maximumValue,boolean required,boolean disabled,boolean customRendering,String candidateValues,String suggestValues, String [] tokensExpr) throws Exception
	{	
	...
	protected FormField createFormField(LscUserContext userContext, String label, String localeKey, String parameterName, String type, String placeholder, String defaultValue, String description, String fieldGroup, String minimumValue, String maximumValue, boolean required, boolean disabled, boolean customRendering, String candidateValues, String suggestValues) throws Exception{
	...
	protected void checkParamsForRemovingFormFieldList(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormFieldList(LscUserContext userContext, String genericFormId, 
			String formFieldIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormField(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormField(LscUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormField(LscUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormFieldFrom(LscUserContext userContext, String genericFormId, 
		String formFieldId, int formFieldVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormField(LscUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormField(LscUserContext userContext, String genericFormId, String formFieldId, int formFieldVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	*/
	...
	protected void checkParamsForAddingFormAction(LscUserContext userContext, String genericFormId, String label, String localeKey, String actionKey, String level, String url,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormActionProperties(LscUserContext userContext, String genericFormId,String id,String label,String localeKey,String actionKey,String level,String url,String [] tokensExpr) throws Exception {
	...
	public  GenericForm updateFormActionProperties(LscUserContext userContext, String genericFormId, String id,String label,String localeKey,String actionKey,String level,String url, String [] tokensExpr) throws Exception
	{	
	...
	protected FormAction createFormAction(LscUserContext userContext, String label, String localeKey, String actionKey, String level, String url) throws Exception{
	...
	protected void checkParamsForRemovingFormActionList(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormActionList(LscUserContext userContext, String genericFormId, 
			String formActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFormAction(LscUserContext userContext, String genericFormId, 
	...
	public  GenericForm removeFormAction(LscUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFormAction(LscUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	public  GenericForm copyFormActionFrom(LscUserContext userContext, String genericFormId, 
		String formActionId, int formActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingFormAction(LscUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  GenericForm updateFormAction(LscUserContext userContext, String genericFormId, String formActionId, int formActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
