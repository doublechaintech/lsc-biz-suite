...
public class LscExceptionJsonSerializer extends  JsonSerializer<LscException> {
	...
	@Override
	public void serialize(LscException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, LscException exception,
	...
	protected void writeStartObject(LscException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(LscException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,LscException exception,
	...
	protected void writeMessageList(String fieldName,LscException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
