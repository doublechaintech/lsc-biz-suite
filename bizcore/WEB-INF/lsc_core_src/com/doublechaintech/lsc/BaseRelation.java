...
public class BaseRelation{
	...
	protected void prepareRelationIndex()
	{
		...
		addRelationIndex("TransactionType",transactionTypeRelatedObjectNames);

		String [] merchantTypeRelatedObjectNames = {"platform:Platform"};
		addRelationIndex("MerchantType",merchantTypeRelatedObjectNames);

		String [] transportTaskStatusRelatedObjectNames = {"platform:Platform"};
		addRelationIndex("TransportTaskStatus",transportTaskStatusRelatedObjectNames);
		...
		addRelationIndex("Merchant",merchantRelatedObjectNames);

		String [] transportProjectRelatedObjectNames = {"merchant:Merchant","platform:Platform"};
		addRelationIndex("TransportProject",transportProjectRelatedObjectNames);
		...
		addRelationIndex("MerchantAccount",merchantAccountRelatedObjectNames);
	...
	{
		addGenericRelation("TransactionType"                       ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("MerchantType"                          ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("TransportTaskStatus"                   ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("Location"                              ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("Merchant"                              ,TRUST_CHAIN_READ,"type");
		addGenericRelation("Merchant"                              ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("TransportProject"                      ,TRUST_CHAIN_READ,"merchant");
		addGenericRelation("TransportProject"                      ,TRUST_CHAIN_READ,"platform");
		...
		addGenericRelation("TransportTask"                         ,TRUST_CHAIN_READ,"sender");
		addGenericRelation("TransportTask"                         ,TRUST_CHAIN_READ,"receiver");
		addGenericRelation("TransportTask"                         ,TRUST_CHAIN_READ,"platform");
		addGenericRelation("TransportTaskTrack"                    ,TRUST_CHAIN_READ,"task");
		addGenericRelation("MerchantAccount"                       ,TRUST_CHAIN_READ,"merchant");
		addGenericRelation("Transaction"                           ,TRUST_CHAIN_READ,"transactionType");
		addGenericRelation("Transaction"                           ,TRUST_CHAIN_READ,"account");
