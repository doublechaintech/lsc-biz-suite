...
public class SecUserBlockingJDBCTemplateDAO extends LscNamingServiceDAO implements SecUserBlockingDAO{
	...
	*/
    ...
    public SmartList<SecUserBlocking> requestCandidateSecUserBlockingForSecUser(LscUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
