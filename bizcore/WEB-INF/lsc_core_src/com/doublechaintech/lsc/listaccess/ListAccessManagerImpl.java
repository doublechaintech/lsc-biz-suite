...
public class ListAccessManagerImpl extends CustomLscCheckerManager implements ListAccessManager {
	...
	protected void throwExceptionWithMessage(String value) throws ListAccessManagerException{
 	...
 	protected ListAccess saveListAccess(LscUserContext userContext, ListAccess listAccess, String [] tokensExpr) throws Exception{	
 	...
 	protected ListAccess saveListAccessDetail(LscUserContext userContext, ListAccess listAccess) throws Exception{	
 	...
 	public ListAccess loadListAccess(LscUserContext userContext, String listAccessId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public ListAccess searchListAccess(LscUserContext userContext, String listAccessId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected ListAccess present(LscUserContext userContext, ListAccess listAccess, Map<String, Object> tokens) throws Exception {
 	...
 	public ListAccess loadListAccessDetail(LscUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, allTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	
 	public Object view(LscUserContext userContext, String listAccessId) throws Exception{	
 		ListAccess listAccess = loadListAccess( userContext, listAccessId, viewTokens());
 		return present(userContext,listAccess, allTokens());
		
 	}
 	protected ListAccess saveListAccess(LscUserContext userContext, ListAccess listAccess, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getListAccessDAO().save(listAccess, tokens);
 	}
 	protected ListAccess loadListAccess(LscUserContext userContext, String listAccessId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfListAccess(listAccessId);
		userContext.getChecker().throwExceptionIfHasErrors( ListAccessManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(LscUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(LscUserContext userContext, ListAccess listAccess, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingListAccess(LscUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public ListAccess clone(LscUserContext userContext, String fromListAccessId) throws Exception{
	...
	public ListAccess internalSaveListAccess(LscUserContext userContext, ListAccess listAccess, Map<String,Object> options) throws Exception 
	{
	...
	public ListAccess updateListAccessProperty(LscUserContext userContext,String listAccessId, int listAccessVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingListAccess(userContext, listAccessId, listAccessVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherApp(LscUserContext userContext, String listAccessId, String anotherAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(LscUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
	...
	public ListAccess forgetByAll(LscUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
		return forgetByAllInternal(userContext, listAccessId, listAccessVersion);		
	}
	protected ListAccess forgetByAllInternal(LscUserContext userContext,
			String listAccessId, int listAccessVersion) throws Exception{
