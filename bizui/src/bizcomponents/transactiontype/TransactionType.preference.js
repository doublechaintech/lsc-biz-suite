...
const renderPermissionSetting = transactionType => {
  const {TransactionTypeBase} = GlobalComponents
  return <PermissionSetting targetObject={transactionType}  targetObjectMeta={TransactionTypeBase}/>
