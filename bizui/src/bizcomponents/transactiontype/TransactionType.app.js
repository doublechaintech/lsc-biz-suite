...
class TransactionTypeBizApp extends React.PureComponent {
  ...
  getTransactionSearch = () => {
    ...
    return connect(state => ({
      ...
      count: state._transactionType.transactionCount,
      ...
      searchParameters: {...state._transactionType.searchParameters},
      expandForm: state._transactionType.expandForm,
  ...
  buildRouters = () =>{
  	...
  	{path:"/transactionType/:id/list/transactionList", component: this.getTransactionSearch()},
  	{path:"/transactionType/:id/list/transactionCreateForm", component: this.getTransactionCreateForm()},
  	{path:"/transactionType/:id/list/transactionUpdateForm", component: this.getTransactionUpdateForm()},
   ...
   render() {
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.transactionType)}
