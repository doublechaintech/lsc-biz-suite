...
componentDidMount() {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`transactionTypeList.searchField`] = fieldName
    value[`transactionTypeList.searchVerb`] =  searchVerb
    value[`transactionTypeList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['transactionTypeList'] = 1
      params['transactionTypeList.orderBy.0'] = "id"
      params['transactionTypeList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        transactionTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={TransactionTypeService.requestCandidatePlatform}/>
