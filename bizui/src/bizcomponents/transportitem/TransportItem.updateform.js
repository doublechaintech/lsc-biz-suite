...
import styles from './TransportItem.updateform.less'
...
class TransportItemUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const transportItemId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, transportItemId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateTransportItem`,
          payload: {
            id: owner.id,
            type: 'transportItem',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextTransportItemUpdateRow`,
        payload: {
          id: owner.id,
          type: 'transportItem',
          selectedRows,
...
}))(Form.create()(TransportItemUpdateForm))
