...
class TransportItemSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      transportItemList: 1,
      'transportItemList.searchField': fieldName,
      'transportItemList.searchVerb': 'startsWith',
      'transportItemList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`transportItemList.searchField`] = fieldName
    value[`transportItemList.searchVerb`] =  searchVerb
    value[`transportItemList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'unit'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'project'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'eq', 'merchant'))
      ...
      params['transportItemList'] = 1
      params['transportItemList.orderBy.0'] = "id"
      params['transportItemList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        transportItemSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"project"} 
                    requestFunction={TransportItemService.requestCandidateProject}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"merchant"} 
                    requestFunction={TransportItemService.requestCandidateMerchant}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={TransportItemService.requestCandidatePlatform}/>
...
export default Form.create()(TransportItemSearchForm)
