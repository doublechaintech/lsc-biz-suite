...
import styles from './TransportItem.dashboard.less'
...
const imageList =(transportItem)=>{return [
	 ]}

const internalImageListOf = (transportItem) =>defaultImageListOf(transportItem,imageList)

const optionList =(transportItem)=>{return [ 
	]}

const buildTransferModal = defaultBuildTransferModal
const showTransferModel = defaultShowTransferModel
const internalSettingListOf = (transportItem) =>defaultSettingListOf(transportItem, optionList)
...
class TransportItemDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    if(!this.props.transportItem.class){
      return null
    }
...
}))(Form.create()(TransportItemDashboard))
