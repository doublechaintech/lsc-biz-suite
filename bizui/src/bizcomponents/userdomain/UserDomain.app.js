...
class UserDomainBizApp extends React.PureComponent {
  ...
  getSecUserCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._userDomain.secUserSearchFormParameters,
      loading: state._userDomain.loading,
      owner: { type: '_userDomain', id: state._userDomain.id, referenceName: 'domain', listName: 'secUserList', ref:state._userDomain, listDisplayName: '安全用户列表'}, // this is for model namespace and
    }))(SecUserCreateForm)
  }
  ...
  getSecUserUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      role: "secUser",
      currentUpdateIndex: state._userDomain.currentUpdateIndex,
      owner: { type: '_userDomain', id: state._userDomain.id, listName: 'secUserList', ref:state._userDomain, listDisplayName: '安全用户列表' }, // this is for model namespace and
    }))(SecUserUpdateForm)
  }
