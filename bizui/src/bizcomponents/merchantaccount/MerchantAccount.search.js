...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{merchantAccountList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'merchant')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'merchant')}/> 
...
class MerchantAccountSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {MerchantAccountTable} = GlobalComponents;
    const {MerchantAccountSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <MerchantAccountSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,MerchantAccountModalTable,"merchantAccountIds")}
...
export default Form.create()(MerchantAccountSearch)
