...
import styles from './MerchantAccount.search.less'
...
class MerchantAccountSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      merchantAccountList: 1,
      'merchantAccountList.searchField': fieldName,
      'merchantAccountList.searchVerb': 'startsWith',
      'merchantAccountList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`merchantAccountList.searchField`] = fieldName
    value[`merchantAccountList.searchVerb`] =  searchVerb
    value[`merchantAccountList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['merchantAccountList'] = 1
      params['merchantAccountList.orderBy.0'] = "id"
      params['merchantAccountList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        merchantAccountSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"merchant"} 
                    requestFunction={MerchantAccountService.requestCandidateMerchant}/>
...
export default Form.create()(MerchantAccountSearchForm)
