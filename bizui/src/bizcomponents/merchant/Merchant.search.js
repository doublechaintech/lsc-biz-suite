...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
    ...
    <MerchantTypeAssociateForm 
	visible={currentAssociateModal==='type'} 
	data={{merchantList:selectedRows}} owner={owner}  
...
class MerchantSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {MerchantTable} = GlobalComponents;
    const {MerchantSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        ...
        {showDeletionDialog(this,MerchantModalTable,"merchantIds")}
...
export default Form.create()(MerchantSearch)
