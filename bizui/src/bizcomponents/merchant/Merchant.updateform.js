...
import styles from './Merchant.updateform.less'
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const merchantId = values.id
        const imagesValues = mapBackToImageValues(convertedImagesValues)
        const parameters = { ...values, merchantId, ...imagesValues }
    ...
    const submitUpdateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        dispatch({
          type: `${owner.type}/updateMerchant`,
          payload: {
            id: owner.id,
            type: 'merchant',
            parameters,
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextMerchantUpdateRow`,
        payload: {
          id: owner.id,
          type: 'merchant',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新Merchant"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新Merchant"
...
}))(Form.create()(MerchantUpdateForm))
