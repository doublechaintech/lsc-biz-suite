...
class MerchantCreateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addMerchant`,
          payload: { id: owner.id, type: 'merchant', parameters, continueNext: true },
        })
      })
    }
...
}))(Form.create()(MerchantCreateForm))
