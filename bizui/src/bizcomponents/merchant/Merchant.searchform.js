...
import styles from './Merchant.search.less'
...
class MerchantSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      merchantList: 1,
      'merchantList.searchField': fieldName,
      'merchantList.searchVerb': 'startsWith',
      'merchantList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`merchantList.searchField`] = fieldName
    value[`merchantList.searchVerb`] =  searchVerb
    value[`merchantList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['merchantList'] = 1
      params['merchantList.orderBy.0'] = "id"
      params['merchantList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        merchantSearchFormParameters: filterObjectKeys(fieldsValue),
...
export default Form.create()(MerchantSearchForm)
