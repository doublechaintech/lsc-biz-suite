...
class LocationBizApp extends React.PureComponent {
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/location/${this.props.location.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/location/${this.props.location.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getTransportTaskAsSourceSearch = () => {
    ...
    return connect(state => ({
      ...
      count: state._location.transportTaskAsSourceCount,
  ...
  getTransportTaskAsSourceUpdateForm = () => {
  ...
  getTransportTaskAsDestinationSearch = () => {
    const {TransportTaskSearch} = GlobalComponents;
    return connect(state => ({
      rule: state.rule,
      ...
      count: state._location.transportTaskAsDestinationCount,
  ...
  getTransportTaskAsDestinationUpdateForm = () => {
  	const {TransportTaskUpdateForm} = GlobalComponents;
    return connect(state => ({
      selectedRows: state._location.selectedRows,
      role: "transportTaskAsDestination",
  ...
  buildRouters = () =>{
  	...
  	const {LocationPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/location/:id/dashboard", component: LocationDashboard},
  	{path:"/location/:id/preference", component: LocationPreference},
  	
  	
  	
  	{path:"/location/:id/list/transportTaskListAsSource", component: this.getTransportTaskAsSourceSearch()},
  	{path:"/location/:id/list/transportTaskAsSourceCreateForm", component: this.getTransportTaskAsSourceCreateForm()},
  	{path:"/location/:id/list/transportTaskAsSourceUpdateForm", component: this.getTransportTaskAsSourceUpdateForm()},
   	
  	{path:"/location/:id/list/transportTaskListAsDestination", component: this.getTransportTaskAsDestinationSearch()},
  	{path:"/location/:id/list/transportTaskAsDestinationCreateForm", component: this.getTransportTaskAsDestinationCreateForm()},
  	{path:"/location/:id/list/transportTaskAsDestinationUpdateForm", component: this.getTransportTaskAsDestinationUpdateForm()},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {LocationEditDetail} = GlobalComponents
     //const {LocationViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.location)}
