...
componentDidMount() {
  ...
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`locationList.searchField`] = fieldName
    value[`locationList.searchVerb`] =  searchVerb
    value[`locationList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'contactPerson'))
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'contactPhone'))
      ...
      params['locationList'] = 1
      params['locationList.orderBy.0'] = "id"
      params['locationList.descOrAsc.0'] = "desc"
