...
class MerchantTypeTable extends PureComponent {
  state = {
    selectedRowKeys: [],
  }
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
         ...
         { hasReadPermission(metaInfo)&&<Link to={`/merchantType/${record.id}/dashboard`}>{'查看'}</Link>}
...
export default MerchantTypeTable
