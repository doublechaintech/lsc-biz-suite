...
import styles from './MerchantType.search.less'
...
class MerchantTypeSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      merchantTypeList: 1,
      'merchantTypeList.searchField': fieldName,
      'merchantTypeList.searchVerb': 'startsWith',
      'merchantTypeList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`merchantTypeList.searchField`] = fieldName
    value[`merchantTypeList.searchVerb`] =  searchVerb
    value[`merchantTypeList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['merchantTypeList'] = 1
      params['merchantTypeList.orderBy.0'] = "id"
      params['merchantTypeList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        merchantTypeSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={MerchantTypeService.requestCandidatePlatform}/>
...
export default Form.create()(MerchantTypeSearchForm)
