...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{merchantTypeList:selectedRows}} owner={owner}  
...
class MerchantTypeSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {MerchantTypeTable} = GlobalComponents;
    const {MerchantTypeSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <MerchantTypeSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,MerchantTypeModalTable,"merchantTypeIds")}
...
export default Form.create()(MerchantTypeSearch)
