...
import styles from './TransportProject.search.less'
...
class TransportProjectSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      transportProjectList: 1,
      'transportProjectList.searchField': fieldName,
      'transportProjectList.searchVerb': 'startsWith',
      'transportProjectList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`transportProjectList.searchField`] = fieldName
    value[`transportProjectList.searchVerb`] =  searchVerb
    value[`transportProjectList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['transportProjectList'] = 1
      params['transportProjectList.orderBy.0'] = "id"
      params['transportProjectList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        transportProjectSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"merchant"} 
                    requestFunction={TransportProjectService.requestCandidateMerchant}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"platform"} 
                    requestFunction={TransportProjectService.requestCandidatePlatform}/>
...
export default Form.create()(TransportProjectSearchForm)
