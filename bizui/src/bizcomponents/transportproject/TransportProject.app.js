...
import styles from './TransportProject.app.less'
...
class TransportProjectBizApp extends React.PureComponent {
  constructor(props) {
    super(props)
  ...
  getNavMenuItems = (targetObject) => {
    ...
    return (
		  ...
		  <Menu
           ...
           >
             ...
             <Menu.Item key="dashboard">
               <Link to={`/transportProject/${this.props.transportProject.id}/dashboard`}><Icon type="dashboard" /><span>仪表板</span></Link>
             </Menu.Item>
       ...
       <Menu.Item key="preference">
               <Link to={`/transportProject/${this.props.transportProject.id}/preference`}><Icon type="setting" /><span>设置</span></Link>
             </Menu.Item>
  ...
  getTransportItemSearch = () => {
    ...
    return connect(state => ({
      ...
      count: state._transportProject.transportItemCount,
  ...
  buildRouters = () =>{
  	const {TransportProjectDashboard} = GlobalComponents
  	const {TransportProjectPreference} = GlobalComponents
  	
  	
  	const routers=[
  	{path:"/transportProject/:id/dashboard", component: TransportProjectDashboard},
  	{path:"/transportProject/:id/preference", component: TransportProjectPreference},
  ...
  handleOpenChange = (openKeys) => {
   ...
   render() {
     ...
     //const {TransportProjectEditDetail} = GlobalComponents
     //const {TransportProjectViewDetail} = GlobalComponents
     ...
     <Layout>
       ...
       <Layout>
		 ...
		 {this.getNavMenuItems(this.props.transportProject)}
