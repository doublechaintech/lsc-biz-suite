...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{transportProjectList:selectedRows}} owner={owner}  
...
class TransportProjectSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {TransportProjectTable} = GlobalComponents;
    const {TransportProjectSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <TransportProjectSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,TransportProjectModalTable,"transportProjectIds")}
...
export default Form.create()(TransportProjectSearch)
