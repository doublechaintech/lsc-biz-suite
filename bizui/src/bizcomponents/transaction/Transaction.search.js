...
const showAssociateDialog = (targetComponent) => {
  ...
  const { TransactionTypeAssociateForm } = GlobalComponents
  const { MerchantAccountAssociateForm } = GlobalComponents
  ...
  <div>
    ...
    <TransactionTypeAssociateForm 
	visible={currentAssociateModal==='transactionType'} 
	data={{transactionList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'transactionType')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'transactionType')}/> <MerchantAccountAssociateForm 
	visible={currentAssociateModal==='account'} 
	data={{transactionList:selectedRows}} owner={owner}  
	onCancel={()=>toggleAssociateModalVisible(targetComponent,'account')} 
	onCreate={()=>toggleAssociateModalVisible(targetComponent,'account')}/> 
