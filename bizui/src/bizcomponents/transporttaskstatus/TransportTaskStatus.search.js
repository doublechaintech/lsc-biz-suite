...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{transportTaskStatusList:selectedRows}} owner={owner}  
...
class TransportTaskStatusSearch extends PureComponent {
  state = {
  ...
  render(){
    ...
    const {TransportTaskStatusTable} = GlobalComponents;
    const {TransportTaskStatusSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        <Card bordered={false}>
          <div className={styles.tableList}>
            <div className={styles.tableListForm}>
              <TransportTaskStatusSearchForm {...this.props} />
            </div>
        ...
        {showDeletionDialog(this,TransportTaskStatusModalTable,"transportTaskStatusIds")}
...
export default Form.create()(TransportTaskStatusSearch)
