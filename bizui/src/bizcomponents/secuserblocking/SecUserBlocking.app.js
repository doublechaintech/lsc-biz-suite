...
class SecUserBlockingBizApp extends React.PureComponent {
  ...
  getSecUserSearch = () => {
    ...
    return connect(state => ({
      ...
      listDisplayName: '安全用户列表' }, // this is for model namespace and
    }))(SecUserSearch)
  }
  getSecUserCreateForm = () => {
    ...
    return connect(state => ({
      ...
      searchFormParameters: state._secUserBlocking.secUserSearchFormParameters,
      loading: state._secUserBlocking.loading,
      owner: { type: '_secUserBlocking', id: state._secUserBlocking.id, referenceName: 'blocking', listName: 'secUserList', ref:state._secUserBlocking, listDisplayName: '安全用户列表'}, // this is for model namespace and
    }))(SecUserCreateForm)
  }
  ...
  getSecUserUpdateForm = () => {
    ...
    return connect(state => ({
      ...
      owner: { type: '_secUserBlocking', id: state._secUserBlocking.id, listName: 'secUserList', ref:state._secUserBlocking, listDisplayName: '安全用户列表' }, // this is for model namespace and
    }))(SecUserUpdateForm)
  }
